<?php
class jr_cr_node extends jr_cr_item implements PHPCR_NodeInterface {
    protected $id = null;
    ...
    function __construct($session, $JRnode) {
        parent::__construct($session, $JRnode);
        $this->JRnode = $JRnode;
    }
    ...
    public function getBaseVersion() {
        return new jr_cr_node($this->session,$this->JRnode->getBaseVersion()); //TODO: error handling
    }
